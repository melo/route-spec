...
my @test_cases = (
  ...
  ## Actually it could be a generic matcher if the default_re was configurable
  { spec  => ':name had a little :pet, and she liked to :action with it {time:\d+} times!',
    ...
    test_against => [
      ...
      {url => 'Suzy had a little dog, and she liked to run with it several times!'},
      { url     => 'Maggy had a little boyfriend, and she liked to kiss with it 10 times! For real!',
        matched => 'Maggy had a little boyfriend, and she liked to kiss with it 10 times!',
        args    => {
          name  => 'Maggy',
          pet  => 'boyfriend',
          action  => 'kiss',
    ...
    url_for => [
      { url  => 'Blanche had a little partner, and she liked to perform with it 20 times! What a show that was!',
        args => {
          name  => 'Blanche',
          pet  => 'partner',
          action  => 'perform',
